...
*   **Discord Webhook (optional)**: Sends jail and unjail events to a Discord webhook in the same embed style/colors as BanHammer. If BanHammer is installed, Jail Mod will reuse BanHammer's webhook automatically unless you set one in Jail Mod's config.
